...
export const Layout: React.FC<LayoutProps> = ({ children, currentView, setView, user, onLogout, onEditProfile, requestsBadgeCount = 0, validationsBadgeCount = 0 }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50/50">
      ...
      <footer className="bg-white border-t border-gray-100 py-3 sm:py-4 md:py-6 flex justify-center items-center text-[7px] sm:text-[8px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest px-4 text-center">
